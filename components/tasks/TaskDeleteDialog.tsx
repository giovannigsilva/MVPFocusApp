        ...
        startTransition(async () => {
            try {
                ...
                if (error.message && error.message.includes('NEXT_REDIRECT')) {
                    // Fechamos o modal, exibimos o toaster de sucesso e deixamos o redirect acontecer.
                    setIsOpen(false);
                    toast.success('Livro excluído!', {
                        description: `"${bookTitle}" foi removido com sucesso da biblioteca.`,
                    });
                    // Lançamos novamente o erro para o fluxo de navegação do Next.js continuar
                    throw error;
                }
                // feedback visual claro
