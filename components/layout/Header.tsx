...
import { BookOpenText, Home, List, PlusCircle, Menu, BookMarked, LogOut, User, Target } from 'lucide-react';
...
const navItems = [
    ...
    { name: 'Minhas Tasks', href: '/books', icon: List },
    { name: 'Adicionar Task', href: '/books/new', icon: PlusCircle },
